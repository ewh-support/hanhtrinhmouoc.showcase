...
//                 $http.post('/post/LatestPost', { page: page }).then(function onSuccess(response) {
...
//             $scope.onprev = function () { ltr = false; page--; loadPage(); }
//             $scope.onnext = function () { ltr = true; page++; loadPage(); }
